...
<div class="flex flex-col w-full items-center justify-center">
	<div class="flex w-full max-w-[1440px] flex-col gap-32 pt-16 pb-32 px-8 min-[1440px]:px-2">
	...
	<div class="bg-background flex w-full flex-col gap-8 px-8 xl:flex-row xl:justify-between xl:gap-20">
		<div class="flex w-full max-w-[1440px] flex-col gap-32 pt-16 pb-32 px-8 min-[1440px]:px-2">
			<div class="flex w-full justify-between gap-20">
				<img src="/images/resume_profile.png" alt="Resumé profile" class="hidden h-full lg:block lg:w-80 xl:w-md" />
				<div class="flex w-full flex-col gap-12">
