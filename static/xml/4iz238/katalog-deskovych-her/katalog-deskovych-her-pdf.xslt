...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <fo:root font-family="Arial, 'Segoe UI Emoji', Helvetica, sans-serif">
            ...
            <fo:page-sequence master-reference="A4">
                ...
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <fo:table table-layout="fixed" width="100%" border-collapse="collapse" font-size="10pt">
                        ...
                        <fo:table-body>
                            <xsl:apply-templates select="//k:hra" mode="table-row">
                    ...
                    <fo:block margin-top="10pt" font-size="9pt" font-style="italic" text-align="right">
                        Celkem her v katalogu: <xsl:value-of select="count(//k:hra)"/>
                    </fo:block>
                    ...
                    <xsl:apply-templates select="//k:hra" mode="detail-card">
                        <xsl:sort select="k:nazvy/k:nazev"/>
                    </xsl:apply-templates>
        ...
        <fo:table-row border-bottom="1pt solid #ccc">
            ...
            <fo:table-cell padding="5pt" border="1pt solid #ccc">
                <fo:block font-size="9pt">
                    ...
                    <xsl:if test="count(k:autori/k:autor) > 1"> a kol.</xsl:if>
                </fo:block>
            </fo:table-cell>
                    ...
                    <fo:table-row>
                        ...
                        <fo:table-cell>
                            ...
                            <fo:block font-size="12pt" font-weight="bold" color="#4F46E5" margin-bottom="8pt">
                                ...
                                <xsl:text> </xsl:text>
                                <xsl:value-of select="k:cena/@mena"/>
                                <fo:inline color="black" font-weight="normal" font-size="10pt" margin-left="10pt">
                                    (Hodnocení: <xsl:value-of select="k:hodnoceni/k:body[@zdroj='Vlastní']"/>/10)
                                </fo:inline>
                            </fo:block>
                            
                            <fo:block font-size="10pt" margin-bottom="8pt" text-align="justify">
